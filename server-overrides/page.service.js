...
let PageService = PageService_1 = class PageService {
    ...
    async create(userId, workspaceId, createPageDto, trx, isBase = false) {
        ...
        if (trx) {
            await this.watcherService.addPageWatchers([userId], page.id, createPageDto.spaceId, workspaceId, trx);
        }
        else {
            this.generalQueue
