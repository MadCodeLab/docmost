import{Dn as e,Rn as t,bn as n,ir as r,ln as i,on as a,sr as o,wt as s,xn as c}from"./chunk-J7OUQ5F2-BUuuYMiX.js";var l=``,u=``,d=``,f=[],p=new Map,m=o(e=>t(e,c()),`sanitizeText`),h=o(e=>{switch(e.type){case`terminal`:return{...e,value:m(e.value)};case`nonterminal`:return{...e,name:m(e.name)};case`sequence`:return{...e,elements:e.elements.map(h)};case`choice`:return{...e,alternatives:e.alternatives.map(h)};case`optional`:return{...e,element:h(e.element)};case`repetition`:return{...e,element:h(e.element),separator:e.separator?h(e.separator):void 0};case`special`:return{...e,text:m(e.text)}}},`sanitizeAstNode`),g=o(()=>{l=``,u=``,d=``,f.length=0,p.clear(),a(),r.debug(`[Railroad] Database cleared`)},`clear`),_=o(e=>{l=m(e),r.debug(`[Railroad] Title set:`,e)},`setTitle`),v=o(()=>l,`getTitle`),y={clear:g,setTitle:_,getTitle:v,addRule:o(e=>{let t={...e,name:m(e.name),definition:h(e.definition),comment:e.comment?m(e.comment):void 0};r.debug(`[Railroad] Adding rule:`,t.name),p.has(t.name)&&r.warn(`[Railroad] Rule '${t.name}' is already defined. Overwriting.`),f.push(t),p.set(t.name,t)},`addRule`),getRules:o(()=>f,`getRules`),getRule:o(e=>p.get(e),`getRule`),setAccTitle:o(e=>{u=m(e).replace(/^\s+/g,``),r.debug(`[Railroad] Accessibility title set:`,e)},`setAccTitle`),getAccTitle:o(()=>u,`getAccTitle`),setAccDescription:o(e=>{d=m(e).replace(/\n\s+/g,`
